...
function TransitInfo({ selectedTransitLines, busToColor, busToStop, busToTimes, buses }) {
                                        ...
                                        if (busToTimes[option]?.[index]?.CalculatedDepartureTime) {
                                            ...
                                            return (
                                                <TimelineItem>
                                                    ...
                                                    <TimelineSeparator>
                                                        {bus[0].stopId == stop.stopCode && stop.isTimePoint === "N" && (
                                                        ...
                                                        {bus[0].stopId == stop.stopCode && stop.isTimePoint === "Y" && (
                                                            <TimelineDot>
